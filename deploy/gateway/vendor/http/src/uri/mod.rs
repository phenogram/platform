...
// Phenogram compatibility patch: the pinned official Telegram Bot API reader
// accepts a complete request head up to 256 KiB. Hyper needs to represent an
// origin-form request target of the same size without `http::Uri` rejecting it.
